...
function ServiceCard({ name, detail, icon }: CardProps) {
  return (
    <div className="md:w-[19.427vw] h-[42.558vw] w-[71.628vw] md:h-[12.656vw] shadow-md md:py-[1.875vw] md:px-[2.135vw] p-[5vw] rounded-lg md:space-y-0 space-y-[3vw] md:my-0 my-[2vw] border-2 border-[var(--color-primary)] border-opacity-20 hover:shadow-xl transition-shadow duration-300 group">
      ...
      <a href="#" className="md:text-[0.938vw] text-[2.28vw] text-[var(--color-primary)] flex items-center justify-center w-fit gap-x-[1vw] hover:text-[var(--color-primary)] transition-colors duration-300">
  ...
  return (
    <section className="aspect-[430/1080] md:aspect-[1920/592] w-full min-h-[46.667vw] md:px-[3vw] md:py-[3vw] px-[5vw] flex flex-col items-center bg-white text-gray-800 relative">
      ...
      <div className="flex flex-col items-center justify-center md:my-0 my-[5vw]">
        <h1 className="font-bold text-[3.567vw] md:text-[1.25vw] text-[var(--color-secondary)]">Our Services</h1>
